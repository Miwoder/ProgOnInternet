...
public class Aaa extends HttpServlet implements Servlet {
    ...
    protected void doPost(HttpServletRequest rq, HttpServletResponse rs)
        ...
        String uri = "http://localhost:48080/Lab15/Bbb";
//        String uri = "http://http://172.16.193.69:8080/AS_3022BAU/Bbb";
        PostMethod pm = new PostMethod(uri);
        pm.addRequestHeader("FirstName", "Andrey");
        pm.addRequestHeader("LastName", "Bekh");
